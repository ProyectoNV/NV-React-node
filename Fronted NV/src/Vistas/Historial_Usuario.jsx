            ...
            <div className="info-text">
                ...
                <div>
                    <form className="cont_info">
                        ...
                        <div class="btn_actu"><button className="button_formu" type="submit" id="btn_actu-u" onClick={Mostrar}>Actualizar</button></div>
                    </form>
                </div>
                <div>
                    <form class="cont_info">
                        ...
                        <div class="btn_actu"><button className="button_formu" type="submit" id="btn_actu-d" onClick={Mostrar}>Actualizar</button></div>
                    </form>
                </div>
			</div>
        </div>
